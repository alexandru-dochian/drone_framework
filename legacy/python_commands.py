...
URI = uri_helper.uri_from_env(default='radio://0/100/2M/E7E7E7E707')
...
if __name__ == '__main__':
    ...
    with SyncCrazyflie(URI, cf=Crazyflie(rw_cache='./cache')) as scf:
        ...
        with MotionCommander(scf) as mc:
            ...
            mc.right(0.3, velocity=0.4)
            time.sleep(1)
            mc.left(0.3, velocity=0.2)
            time.sleep(1)

            # We can do circles or parts of circles
            mc.circle_right(0.4, velocity=0.4, angle_degrees=180)
